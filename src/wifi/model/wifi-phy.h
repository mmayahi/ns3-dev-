...
public:
  ...
  */
   ...
   * \param psduDuration the duration of the PSDU
   */
  typedef void (* PhyRxPayloadBeginPacketTracedCallback)(Ptr<const Packet> packet, WifiTxVector txVector, Time psduDuration);
...
private:
   ...
   * \see class CallBackTraceSource
   */
  TracedCallback<WifiConstPsduMap, WifiTxVector, double /* TX power (W) */, Time> m_phyTxPsduBeginTrace;
  ...
  TracedCallback<Ptr<const WifiPpdu>, WifiTxVector, Time> m_phyRxPayloadBeginPacketTrace;
