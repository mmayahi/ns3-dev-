  ...
  uint8_t txLevel)
{
  ...
  *stream->GetStream () << "t " << Simulator::Now ().GetNanoSeconds () << " " << context << " " << mode << " " << *p << std::endl;
}
  ...
  uint8_t txLevel)
{
  ...
  *stream->GetStream () << "t " << Simulator::Now ().GetNanoSeconds () << " " << mode << " " << *p << std::endl;
}
  ...
  WifiPreamble preamble)
{
  ...
  *stream->GetStream () << "r " << Simulator::Now ().GetNanoSeconds () << " " << mode << "" << context << " " << *p << std::endl;
}
  ...
  WifiPreamble preamble)
{
  ...
  *stream->GetStream () << "r " << Simulator::Now ().GetNanoSeconds () << " " << mode << " " << *p << std::endl;
}
